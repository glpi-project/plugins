...
angular
   ...
   .config(function($translateProvider) {
      $translateProvider
         .translations('fr', {
            ON: "sur",
            SLOGAN: "Étendez GLPI avec les plugins",
            TRENDING: "Tendances",
            ...
            ADDED: "Ajouté",
            BY: "Par",
            CONTRIBUTED_TO: "a contribué à {{plugincount}} plugins",
            PLUGIN_CONTRIBUTED_TO: "a contribué/travaillé sur ces plugins",
            ...
            PLEASE_USE_SUGGESTION_TRACKER: "Si votre message concerne une demande de nouvelle fonctionnalité  pour GLPI, vous êtes fortement incité à utiliser notre feature request tracker à cette adresse",
            FIRSTNAME: "Prénom",
            LASTNAME: "Nom",
            EMAIL: "Email",
            SUBJECT: "Sujet",
            ...
            SUBMIT: "Envoyer",
            SUBMIT_YOUR_PLUGIN: "Ajoutez votre plugin !",
            ...
            INVALID_CREDENTIALS: "Mauvais nom d'utilisateur/mot de passe. Si vous n'êtes plus sûr cliquez sur 'J'ai oublié mon mot de passe'",
            ...
            PLUGIN_UNWATCHED: "Vous cessez de surveiller",
            TAGGED: "Taggé",
            DOWNLOADED: "Téléchargé",
            THIS_MONTH: "Depuis un mois",
            THIS_WEEK: "Cette semaine",
            TRANSLATIONS: "Traductions",
            XMLFILE_UNREACHABLE_URL: 'URL inaccessible',
            ...
            PANEL_APP_DESCRIPTION: 'Description de l\'application (optionnel, exemple "API key pour monscript.monlanguage")',
            PANEL_APP_CREATE: 'Créer',
            PANEL_MY_APPLICATIONS: 'Mes applications',
            PANEL_EDIT_APP_SETTINGS: 'Modifier les réglages de mon application',
            PANEL_SETTINGS: 'Réglages',
            PANEL_CLIENT_ID: 'Identifiant de l\'application (OAuth2 Client ID)',
            PANEL_CLIENT_SECRET: 'Clé secrète (OAuth2 Client Secret)',
            PANEL_APPLICATION_NAME_TOO_SHORT: 'Le nom de votre application doit être d\'au moins {{n}} caractères',
            PANEL_APPLICATION_NAME_TOO_LONG: 'Le nom de votre application ne doit pas excéder {{n}} caractères',
            ...
            PANEL_CLAIM_AN_AUTHORSHIP_FEATURE_DESC: 'Vous pouvez revendiquer votre nom d\'auteur pour être correctement référencé',
            PANEL_CLAIM_AN_AUTHORSHIP_FEATURE_DESC2: 'Si nous acceptons la demande (ie. assurez-vous d\'être l\'auteur légitime), votre compte sera lié à tous vos plugins et recevrez des droits d\'administration spécifiques',
            PANEL_CLAIM_AN_AUTHORSHIP_AUTHOR_NAME: 'Nom d\'auteur (exactement tel que dans le tag <author> des fichiers XML des plugins en question)',
            PANEL_CLAIM_AN_AUTHORSHIP_CLAIM: 'Revendiquer',
            ...
            CONTRIBUTED_TO_N_PLUGINS: 'A contribué à {{plugincount}} plugins',
            ...
            FINISHACTIVATEACCOUNT_SELECT_PRIMARY_EMAIL: 'Sélectionnez une adresse email parmi celles de vos comptes externes',
            ...
            LINKACCOUNT_EXTERNAL_ACCOUNTS: 'Vos comptes réseaux sociaux externes',
            LINKACCOUNT_SERVICE: 'Service',
            LINKACCOUNT_USERID: 'ID utilisateur',
            ...
            NOTIFICATIONS_DISCOVER_AND_SUBSCRIBE: 'Vous pouvez aussi découvrir de nouveaux plugins et commencez à surveiller des plugins grâce au bouton à côté du bouton télécharger (vous devez être authentifié)',
            ...
            PANEL_USERNAME_TOOLONG: 'Votre nom d\'utilisateur ne doit pas excéder {{n}} caractères',
            PANEL_REALNAME: 'Nom réel',
            PANEL_REALNAME_TOOSHORT: 'Votre nom réel doit être d\'au moins {{n}} caractères',
            PANEL_REALNAME_TOOLONG: 'Votre nom réel ne doit pas excéder {{n}} caractères',
            PANEL_EMAIL: 'Email',
            PANEL_FIELD_REQUIRED: 'Champ requis',
            PANEL_INVALID_EMAIL: 'Ceci est une adresse e-mail invalide',
            ...
            PANEL_PASSSWORD_TOOLONG: 'Le mot de passe ne doit pas excéder {{n}} caractères',
            ...
            PANEL_UNREACHABLE_XML_FILE_URL: 'URL du fichier XML inatteignable',
            ...
            PLUGIN_PANEL_XML_STATE: 'État du XML',
            ...
            PLUGIN_PERMISSIONS_OF_PLUGIN: 'Réglez les permissions des utilisateurs GLPi Plugins sur "{{pluginkey}}" Plugin',
            ...
            PLUGIN_PERMISSIONS_ALLOWED_EVERYTHING: 'Tous les droits (Reçoit notifications, Peut changer URL, Peut rafraichir)',
            ...
            SIGNUP_USERNAME_TOOLONG: 'Votre nom d\'utilisateur ne doit pas excéder {{n}} caractères',
            ...
            SIGNUP_REALNAME_TOOSHORT: 'Votre nom complet doit contenir au moins {{n}} caractères',
            SIGNUP_REALNAME_TOOLONG: 'Votre nom complet ne doit pas excéder {{n}} caractères',
            SIGNUP_EMAIL: 'Email',
            SIGNUP_EMAIL_INVALID: 'Cet email est invalide',
            SIGNUP_WEBSITE: 'Site Internet',
            SIGNUP_WEBSITE_INVALID: 'Cette URL de site Internet est invalide',
            ...
            SUBMIT_AND_RESPECT_THIS_FORMAT: 'et respecter ce format',
            ...
            README: 'Readme',
            FORGOTPASSWORD_DIALOG_TITLE: 'Ainsi vous avez oublié votre mot de passe',
